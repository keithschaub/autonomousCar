...
float slots = 20.0;  // Number of slots in the encoder
...
void updateHeading() {
    ...
    float gZ_threshold = 0.01; // originally was set to 0.01
...
void slowForward() {
  ...
  if(0){
    ...
    //String heading_location_packet = "Forward Heading " + String(heading_final) + "," + " deg " + "\n";
    //client.print(heading_location_packet);
  }
...
void slowBackward() {
  ...
  if (0) {
    ...
    String heading_location_packet = "Backward Heading " + String(heading_final) + "," + " deg " + "\n";
    client.print(heading_location_packet);
  }
